...
public class ComplexNumber {
    ...
    /**
     * Calculates the square root of the complex number. The square root of an imaginary number is imaginary.
    ...
    /**
     * Calculates the multiplicative inverse for the complex number. Note that {@link #ZERO} does not have an inverse.
     *
